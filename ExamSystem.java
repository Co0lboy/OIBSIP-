...
public class ExamSystem 
{
    ...
    private static String[][] mcqs = {
        {"What is the capital of INDIA?", "Delhi", "Rome", "London", "A"},
        {"What is the currency of INDIA?", "Rupayee", "Dollar", "Euro", "A"},
        {"Who is the current prime minister of INDIA?", "Rahul Gandhi", "Narendra Modi", "Amit Shaha", "B"},
        {"How many states are in INDIA?", "36", "28", "29", "C"},
        {" Who was the Missile Man of India ?", "Neil Armstrong", "Dr.A.P.J.Kalam", "Michael Collins", "B"}
    };
